...
ALLEGRO_SAMPLE*song14= NULL;
ALLEGRO_SAMPLE_INSTANCE*sample_instance14;
ALLEGRO_SAMPLE*bubblee= NULL;
ALLEGRO_SAMPLE_INSTANCE*sample_instancebubble;
ALLEGRO_SAMPLE*bonkk= NULL;
ALLEGRO_SAMPLE_INSTANCE*sample_instancebonk;
...
ALLEGRO_SAMPLE_INSTANCE*sample_instancewin;
ALLEGRO_SAMPLE*lose=NULL;
ALLEGRO_SAMPLE_INSTANCE*sample_instancelose;
